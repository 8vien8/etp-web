  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Student */}
        <Route path="/user" element={isAuthenticated('student') ? <LandingPage /> : <Navigate to="/login" />} >
        ...
        {/* Coordinator */}
        <Route path="/coordinator" element={isAuthenticated('coordinator') ? <CoordinatorLandingPage /> : <Navigate to="/login" />}>
